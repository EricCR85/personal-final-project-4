...
async function searchMovies(query) {
  ...
  document.getElementById("ratingFilter").addEventListener("change", () => {
    ...
    const filtered = results.filter((movie) => {
      ...
      if (selectedRating === "G") return rating >= 4.5 && rating < 6;
      if (selectedRating === "PG") return rating >= 6 && rating < 7.5;
      if (selectedRating === "PG-13") return rating >= 7.5;
      if (selectedRating === "R") return rating < 4.5;
      return false;
    });
